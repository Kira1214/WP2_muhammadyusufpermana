	...
	//manajemen Kuliner 
		...
		{ 
			...
			if ($this->form_validation->run() == false) { 
				...
				$data = [ 'nama_kuliner' => $this->input->post('nama_kuliner', true), 'keterangan' => $this->input->post('keterangan', true), 'kategori' => $this->input->post('kategori', true), 'alamat' => $this->input->post('alamat', true), 'harga' => $this->input->post('harga', true), 'image' => $gambar ]; $this->ModelWisata->simpanKuliner($data); 
				redirect('kuliner'); 
			} 
		} 
