	...
	//manajemen Wisata 
		...
		{ 
			...
			if ($this->form_validation->run() == false) { 
				...
				$data = [ 'nama_wisata' => $this->input->post('nama_wisata', true), 'kategori' => $this->input->post('kategori', true), 'keterangan' => $this->input->post('keterangan', true), 'alamat' => $this->input->post('alamat', true), 'htm' => $this->input->post('htm', true), 'image' => $gambar ]; $this->ModelWisata->simpanWisata($data); 
				redirect('wisata'); 
			} 
		} 
